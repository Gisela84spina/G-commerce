...
export function ProductDetail() {
  ...
  <><h2><Link className="underline flex font-bold" to={"/"}>
    ...
    <div className=" bg-gradient-to-r from-red-100 via-red-150 to-red-200 grid grid-cols-1  md:grid-cols-2   md:px-16 lg:px-28  gap-5 mt-5 rounded-md mx-auto">

      <div className="flex flex-col items-center bg-gradient-to-r from-slate-100 via-slate-150 to-slate-200  rounded-md m-5">
      ...
      <div className="flex flex-col gap-5 m-5">
        ...
        <div className="flex gap-5 text-2xl text-gray-800">
          <div className="flex gap-5">
            ...
            <span className="bg-gray-500 h-full w-10 font-bold text-xl rounded-xl flex justify-center items-center">{quantity}</span>
          ...
          <button onClick={handleAddToCart} className="my-4 relative flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-gray-900 bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            Add to cart
          </button>

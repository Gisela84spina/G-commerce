  ...
  return (
    <div className='flex justify-between items-center bg-slate-600 text-white p-2 border-b-2 border-slate-700 gap-5 rounded-md'>
        ...
        <div className='grid grid-cols-3 text-center'>
            <button className='bg-gray-200 rounded-full w-6 h-6 text-gray-900' onClick={handleLessQuantity}>-</button>
            <span>{quantity}</span>
            <button className='bg-gray-200 rounded-full w-6 h-6 text-gray-900' onClick={handleMoreQuantity}>+</button>
        </div>
    </div>
  )
}
